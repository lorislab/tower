 ...
 */
public class ApplicationMenuAction extends AbstractContextControllerAction<MenuViewController> {
    
    private static final long serialVersionUID = -4911302278619693549L;

    public ApplicationMenuAction(MenuViewController parent) {
        super(parent, Context.MENU_APPLICATION, Action.EXECUTION);
    }
