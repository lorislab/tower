 ...
 */
public class BTSMenuAction extends AbstractContextControllerAction<MenuViewController> {
    
    private static final long serialVersionUID = -4911302278619693549L;

    public BTSMenuAction(MenuViewController parent) {
        super(parent, Context.MENU_BTS, Action.EXECUTION);
    }
