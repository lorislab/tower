 ...
 */
public class MailMenuAction extends AbstractContextControllerAction<MenuViewController> {
    
    private static final long serialVersionUID = -4911302278619693549L;

    public MailMenuAction(MenuViewController parent) {
        super(parent, Context.MENU_MAIL, Action.EXECUTION);
    }
    
    @Override
    public Object execute() throws Exception {
        return Navigation.TO_MAIL;
    }       
}
