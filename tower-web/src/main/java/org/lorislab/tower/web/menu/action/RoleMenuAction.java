 ...
 */
public class RoleMenuAction extends AbstractContextControllerAction<MenuViewController> {
    
    private static final long serialVersionUID = -4911302278619693549L;

    public RoleMenuAction(MenuViewController parent) {
        super(parent, Context.MENU_ROLE, Action.EXECUTION);
    }
    
    @Override
    public Object execute() throws Exception {
        return Navigation.TO_ROLE;
    }       
}
