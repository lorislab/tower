 ...
 */
public class SCMMenuAction extends AbstractContextControllerAction<MenuViewController> {
    
    private static final long serialVersionUID = -4911302278619693549L;

    public SCMMenuAction(MenuViewController parent) {
        super(parent, Context.MENU_SCM, Action.EXECUTION);
    }
