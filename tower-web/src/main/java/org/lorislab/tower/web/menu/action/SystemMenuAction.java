 ...
 */
public class SystemMenuAction extends AbstractContextControllerAction<MenuViewController> {
    
    private static final long serialVersionUID = -4911302278619693549L;

    public SystemMenuAction(MenuViewController parent) {
        super(parent, Context.MENU_SYSTEM, Action.EXECUTION);
    }
